...
import { useDeleteSubscribers, useSubscribers } from '@/app/(control-panel)/goldrush/api/hooks/useContent';
import type { Subscriber } from '@/app/(control-panel)/goldrush/api/types';
	...
	return (
		<Root
			header={
				<AdminPageHeader
					title="Subscribers"
					subtitle="Newsletter signups from Goldrush"
				/>
			}
			content={
				<Paper
